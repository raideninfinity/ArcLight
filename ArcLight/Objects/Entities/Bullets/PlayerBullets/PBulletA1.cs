...
namespace ArcLight
{
    class PBulletA1 : PlayerBullet
    {

        public PBulletA1(Fighter owner, Vector2 pos, float angle) : base(owner, pos, angle)
        {
            this.owner = owner;
            this.angle = angle;
            x = pos.X;
            y = pos.Y;
            speed = 12.0f;
            damage = Status.PBulletA1_Damage[BurstChain(0)];
        ...
        {
            return Cache.Texture("player_bullet/type_a/bullet_1", 1);
        }
