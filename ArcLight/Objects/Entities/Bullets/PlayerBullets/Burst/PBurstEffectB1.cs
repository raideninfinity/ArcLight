...
namespace ArcLight
{
    public class PBurstEffectB1 : PlayerBullet
    {

        int frame = 0;
        float expl_time = 30;

        public PBurstEffectB1(Fighter owner, Vector2 pos, float angle) : base(owner, pos, angle)
        {
            ...
            x = pos.X;
            y = pos.Y;
            damage = Status.PBurstEffectB1_Damage;
            is_burst = true;
        ...
        {
            float scale = 2.0f * (frame / expl_time);
