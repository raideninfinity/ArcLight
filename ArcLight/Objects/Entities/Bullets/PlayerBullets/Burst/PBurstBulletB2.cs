...
namespace ArcLight
{
    class PBurstBulletB2 : PlayerBullet
    {

        Enemy target;
        int startup_frame = 0;

        public PBurstBulletB2(Fighter owner, Vector2 pos, float angle, Enemy target) : base(owner, pos, angle)
        {
            this.owner = owner;
            this.target = target;
            this.angle = angle;
            ...
            y = pos.Y;
            speed = 12.0f;
            damage = Status.PBurstBulletB2_Damage;
