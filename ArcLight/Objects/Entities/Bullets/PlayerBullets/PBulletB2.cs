...
namespace ArcLight
{
    class PBulletB2 : PlayerBullet
    {

        Enemy target;
        int startup_frame = 8;

        public PBulletB2(Fighter owner, Vector2 pos, float angle, Enemy target) : base(owner, pos, angle)
        {
            this.owner = owner;
            this.target = target;
            this.angle = angle;
            ...
            y = pos.Y;
            speed = 12.0f;
            damage = Status.PBulletB2_Damage[BurstChain(0)];
