...
namespace ArcLight
{
    public class EnemyS2 : Enemy
    {
        int frame;
        public EnemyS2(Vector2 pos, float angle, int polarity = 2)
        {
            hp = GetMaxHP();
            x = pos.X;
            y = pos.Y;
            ...
            kill_score = Status.EnemyS2_KillScore;
        }

        public override float GetMaxHP()
        {
            return Status.EnemyS2_MaxHP;
        }
        ...
        {
            return Cache.Texture("enemy/enemy_s2", 1);
        }
