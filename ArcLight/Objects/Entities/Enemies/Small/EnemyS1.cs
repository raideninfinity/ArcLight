...
namespace ArcLight
{
    public class EnemyS1 : Enemy
    {
        int frame;
        public EnemyS1(Vector2 pos, float angle, int polarity = 2)
        {
            hp = GetMaxHP();
            x = pos.X;
            y = pos.Y;
            ...
            kill_score = Status.EnemyS1_KillScore;
        }

        public override float GetMaxHP()
        {
            return Status.EnemyS1_MaxHP;
        }
        ...
        {
            return Cache.Texture("enemy/enemy_s1", 1);
        }
