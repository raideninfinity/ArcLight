...
namespace ArcLight
{
    public class EnemyM1B : Enemy
    {
        public EnemyM1B(Vector2 pos, float angle, int polarity = 2)
        {
            hp = GetMaxHP();
            x = pos.X;
            y = pos.Y;
            ...
            kill_score = Status.EnemyM1B_KillScore;
        }

        public override float GetMaxHP()
        {
            return Status.EnemyM1B_MaxHP;
        }
        ...
        {
            return Cache.Texture("enemy/enemy_m1_b", 1);
        }
