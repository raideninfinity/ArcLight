...
namespace ArcLight
{
    public class Stage1_P2B : PatternAI
    {
        Vector2 center1 = new Vector2(Graphics.Width - (Graphics.Width / 4 + 24), 24);
        Vector2 distance1 = new Vector2(0, -Graphics.Width / 4);
        Vector2 center2 = new Vector2(Graphics.Width - (Graphics.Width / 4 + 24 + 24), (Graphics.Width / 4) * 2 + 24);
        ...
        public override void UpdateMovement()
        {
            ...
            enemy.pos = center_pos + distance2.TurnAngle(30 + (param - 1) * 120 - 180);
            CheckOutOfBounds(72);
        }
